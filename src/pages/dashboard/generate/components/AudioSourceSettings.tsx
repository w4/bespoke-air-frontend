            ...
            <div className="mt-3 card shadow-sm overflow-hidden border-0 rounded">
                ...
                <div className="card-body">
                    ...
                    <div>
                        ...
                        <div className="d-inline-block float-end"><strong>{this.state.volume}</strong></div>
                        <input type="range" min={0} max={10} step={0.1}
                            value={this.state.volume}
                            onChange={e => this.updateStateAndSendEvent({ ...this.state, volume: Number.parseFloat(e.currentTarget.value) })}
                            className="form-range" id="volume" />
                    </div>
